package com.github.miao1007.wordpressclient.ui.widget;
...
public class SendCommentButton extends ViewAnimator implements View.OnClickListener {
    ...
    private void init() {
        LayoutInflater.from(getContext()).inflate(R.layout.include_send_comment_button, this, true);
    }
